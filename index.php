...
<body>
    <div class="container">
        ...
        <div class="top-heading">
            <h1>Sistem per menaxhimin e shpenzimeve</h1>
        </div>
        <form action="index.php" method="post" onsubmit = "return validate()" id="form1">
            ...
            <div class="group">
                ...
                <input type="text" name="username" placeholder="Emri" id="user1" required>
                <br>
                <small></small>
                </div>
                ...
                <input type="password" name="password" placeholder="Fjalëkalimi" id="pass1" autocomplete="on" required>
                <br>
                <small></small>
                </div>

            </div>
            <button type="submit" class="sign-in" name="login">Hyr</button>
            ...
            <div class="new-account">
                <span style="color: rgba(0, 0, 0, 0.54); font-weight: bolder; font-family: 'Source Sans Pro';">Nuk kam nje llogari?</span> 
                <a href="templates/2-sign-up.php" style="text-decoration: none;"><span style="color: rgba(5, 0, 255, 0.81); font-weight: bolder; font-family: 'Source Sans Pro';">Regjistrohu tani</span></a>
            </div>
